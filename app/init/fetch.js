...
Client4.doFetchWithResponse = async (url, options) => {
    ...
    console.log('In AsyncStorage, @currentServerUrl:', await AsyncStorage.getItem('@currentServerUrl'));
    console.log('In AsyncStorage, @sslWhitelist:', await AsyncStorage.getItem('@sslWhitelist'));
...
// export const addTrustyToGlobalFetchConfig = () => {
//     const trustyConfig = {
//         ...initialConfig,
//         trusty: true,
//     };
//
//     initFetchConfig(trustyConfig);
// };
...
const isSslRelaxed = async () => {
    ...
    // console.log('sslWhitelist:', sslWhitelist);
...
export const initFetchConfig = async () => {
    ...
    console.log('SETTING GLOBAL FETCH!!!!! with fetchConfig', fetchConfig);
